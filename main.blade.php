...
<body class="dark bg-gray-900">
    ...
    <section id="home" class="bg-gray-900">
        <div class="mx-auto grid max-w-screen-xl px-4 py-8 lg:grid-cols-12 lg:gap-8 lg:py-16 xl:gap-0">
            <div class="mr-auto place-self-center lg:col-span-7">
                <h1 class="mb-4 max-w-2xl text-4xl font-extrabold leading-none text-white md:text-5xl xl:text-6xl">
                    @settings('portal::title', 'Minecraft Server Hosting')
                </h1>
                <p class="mb-6 max-w-2xl font-light text-gray-400 md:text-lg lg:mb-8 lg:text-xl">
                ...
                <a href="#pricing"
                    class="bg-primary-600 hover:bg-primary-700 focus:ring-primary-900 mr-3 inline-flex items-center justify-center rounded-lg px-5 py-3 text-center text-base font-medium text-white focus:ring-4">
                ...
                <a href="@settings('socials::discord')"
                    class="inline-flex items-center justify-center rounded-lg border border-gray-700 px-5 py-3 text-center text-base font-medium text-white hover:bg-gray-700 focus:ring-4 focus:ring-gray-800">
    ...
    <section class="bg-gray-900">
        <div class="mx-auto max-w-screen-xl px-4 py-8 lg:py-16">
            <h2
                class="mb-8 text-center text-3xl font-extrabold leading-tight tracking-tight text-white md:text-4xl lg:mb-16">
                {!! __('client.host_favorite_games') !!}</h2>
            <div class="grid grid-cols-2 gap-8 text-gray-400 sm:gap-12 md:grid-cols-3 lg:grid-cols-3">
                <a href="#" class="flex items-center justify-center">
                    <img src="/assets/core/img/logos/rust.png" class="hover:text-white"
                        style="height: 60px;" />
                    <h2
                        class="ml-4 text-center text-3xl font-extrabold leading-tight tracking-tight text-white md:text-3xl">
                        {!! __('client.rust') !!}
                    </h2>
                </a>

                <a href="#" class="flex items-center justify-center">
                    <img src="/assets/core/img/logos/minecraft.png" class="hover:text-white"
                        style="height: 60px;" />
                    <h2
                        class="ml-4 text-center text-3xl font-extrabold leading-tight tracking-tight text-white md:text-3xl">
                        {!! __('client.minecraft') !!}
                ...
                <a href="#" class="flex items-center justify-center">
                    <img src="/assets/core/img/logos/ark.png" class="hover:text-white"
                        style="height: 60px;" />
                    <h2
                        class="ml-4 text-center text-3xl font-extrabold leading-tight tracking-tight text-white md:text-3xl">
                        {!! __('client.ack') !!}
    ...
    <section id="features" class="bg-gray-800">
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6">
            <div class="mb-8 max-w-screen-md lg:mb-16">
                <h2 class="mb-4 text-4xl font-extrabold text-white">{!! __('client.our_game_anel') !!}</h2>
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-3">
                <div>
                    <div
                        class="bg-primary-900 mb-4 flex h-10 w-10 items-center justify-center rounded-full lg:h-12 lg:w-12">
                        <div class="text-primary-300 text-2xl">
                            <i class="bx bxs-file"></i>
                        </div>
                    </div>
                    <h3 class="mb-2 text-xl font-bold text-white">{!! __('client.file_manager') !!}</h3>
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-bold text-white">{!! __('client.plugins_manager') !!}</h3>
                    <p class="text-gray-400">
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-bold text-white">{!! __('client.backup_manager') !!}</h3>
                    <p class="text-gray-400">
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-bold text-white">{!! __('client.user_manager') !!}</h3>
                    <p class="text-gray-400">
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-bold text-white">{!! __('client.schedule_manager') !!}</h3>
                    <p class="text-gray-400">
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-xl font-bold text-white">{!! __('client.database_manager') !!}</h3>
                    <p class="text-gray-400">
        ...
        <div class="mx-auto max-w-screen-xl px-4 py-8 lg:px-6 lg:py-16">
            @if ($selected_category !== null)
                <div class="mx-auto mb-8 max-w-screen-md text-center lg:mb-12">
                    <h2 class="mb-4 text-4xl font-extrabold tracking-tight text-white">{!! __('client.viewing_plans_for') !!}
                        {{ $selected_category->name }}</h2>
                    <p class="mb-5 font-light text-gray-400 sm:text-xl">{{ $selected_category->description }}</p>
                </div>
                    ...
                    @foreach ($selected_category->packages as $package)
                        ...
                        <div
                            ...
                            <div class="my-8 flex items-baseline justify-center">
                                ...
                                <span class="text-gray-400">/{{ $package->prices->first()->periodToHuman() }}</span>
                            </div>
                                ...
                                <div class="grid grid-cols-1 gap-4">
                                    @foreach ($package->features()->orderBy('order', 'desc')->get() as $feature)
                                        <li class="flex items-center space-x-3">
                                            <!-- Icon -->
                                            <span class="text-{{ $feature->color }}-400 bx-sm">
                                                {!! $feature->icon !!}
                                            </span>
                            ...
                            <a href="{{ route('store.package', ['package' => $package->id]) }}"
                                class="bg-primary-600 hover:bg-primary-700 focus:ring-primary-900 rounded-lg px-5 py-2.5 text-center text-sm font-medium text-white focus:ring-4">
    ...
    <section>
        <aside aria-label="Related articles" class="lg:py-15 bg-gray-900 py-8">
            <div class="mx-auto max-w-screen-xl px-4">
                <h2 class="mb-8 text-2xl font-bold text-white">{!! __('client.other_categories') !!}</h2>
                <div class="grid gap-12 sm:grid-cols-2 lg:grid-cols-3">
                    @foreach ($categories->all() as $category)
                        ...
                        <article class="max-w-xs">
                            ...
                            <p class="mb-4 font-light text-gray-400">{{ $category->description }}</p>
                            <a href="{{ url()->current() }}?category={{ $category->link }}#pricing"
                                class="mb-2 mr-2 min-w-full rounded-lg border border-gray-600 bg-gray-800 px-5 py-2.5 text-center text-sm font-medium text-gray-400 hover:bg-gray-700 hover:text-white focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-700">
    ...
    <section class="bg-gray-900">
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center">
                <h2 class="mb-4 text-4xl font-extrabold leading-tight text-white">{!! __('client.get_started_now') !!}</h2>
                <p class="mb-6 font-light text-gray-400 md:text-lg">
                    {!! __('client.register_your_account_no-time') !!}
                </p>
                <a href="{{ route('register') }}"
                    class="bg-primary-600 hover:bg-primary-700 focus:ring-primary-800 mb-2 mr-2 rounded-lg px-5 py-2.5 text-sm font-medium text-white focus:outline-none focus:ring-4">
        ...
        <div class="mx-auto max-w-screen-xl">
            <div class="md:flex md:justify-between">
                ...
                <div class="grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-6">
                    <div>
                        <h2 class="mb-6 text-sm font-semibold uppercase text-white">{!! __('client.resources') !!}</h2>
                    ...
                    <div>
                        <h2 class="mb-6 text-sm font-semibold uppercase text-white">{!! __('client.help_center') !!}</h2>
                        <ul class="text-gray-400">
                            @foreach (Page::getActive() as $page)
                    ...
                    <div>
                        <h2 class="mb-6 text-sm font-semibold uppercase text-white">{!! __('client.legal') !!}</h2>
                        <ul class="text-gray-400">
                            @foreach (Page::getActive() as $page)
